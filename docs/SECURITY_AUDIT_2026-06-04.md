...
- **START:** `_briefError` RangeError can crash app startup (blank screen) on a cold-start storage failure. `main.dart:121`. *(Flutter — ships in the next app build, not a backend deploy.)*
