...
**Status:** the iOS build (`1.0.0`, Apple ID `6766294274`, bundle `com.cliquepix.app`) is **submitted and in active Apple App Store review** as of 2026-06-18 — the move off TestFlight-only toward a public App Store listing. iOS billing was already wired (RevenueCat iOS key `appl_OvhNypnojnQSEebpQtBikJYTHBa` live; `plus_monthly` + `plus_annual` Ready to Submit, attached on the version page).
