...
// no active Clique Pix Plus entitlement. Call immediately after
...
export function requireActiveEntitlement(authUser: AuthenticatedUser): void {
  if (!authUser.entitlementActive) {
